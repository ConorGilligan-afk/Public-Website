...
from jrf.models import Service
...
SERVICES = [
    ...
    },
    {
        ...
        "description": (
            ...
            "team is trained for exactly this: locating the break, excavating safely "
    ...
    },
    {
        ...
        "slug": "ledge-breaking",
        "icon": "ledge-breaking",
        "short_description": "Hydraulic hammering and rock removal when the site hits bedrock.",
        "image": "services/compressed_ledge_breaking.jpg",
        "description": (
            ...
            "through bedrock and keep the job moving, whether that's a small footing obstruction or "
...
class Command(BaseCommand):
    help = "Seeds the Service table with JRF Corp's core service lines."
    ...
    def handle(self, *args, **options):
        for data in SERVICES:
            ...
            self.stdout.write(self.style.SUCCESS(f"{action}: {service.name}"))